            ...
            paragraphe.map((sentence,index) => 
                ...
                <span key={index} id={'s'+index} className='sentence'>
                    ...
                    <span key={index} id={"w" + word.id} className='sentence-item'>
                        {
                                arrayNom.includes(word.word.toLowerCase()) ? 
                                    <b style={{ backgroundColor: "yellow" }}>{word.word}</b>
                                
                                    : 
                                        arrayAdj.includes(word.word.toLowerCase()) ?
                                            <b style={{ backgroundColor: "lightblue" }}>{word.word}</b>
                                    :
